"""
coleman4hcs.api - Library-first public API.

External projects can ``pip install coleman4hcs`` and drive experiments
...
from coleman4hcs.spec.sweep import expand_sweep

if TYPE_CHECKING:
    from coleman4hcs.spec.models import RunSpec
    from coleman4hcs.spec.sweep import SweepSpec
